...
- Reference curated: prometheus-configuration, grafana-dashboards, secrets-management,
  k8s-security-policies, CIS Benchmarks, and a project-specific ops agent if present.
...
Stateful operations hard stop. Hardening overlay on every recreate. SOPS for
