...
- Reference curated: tailwind-design-system, web-component-design, patterns.dev,
  React docs, TanStack, typescript-advanced-types skills.
...
TanStack Query/Router. English only.
