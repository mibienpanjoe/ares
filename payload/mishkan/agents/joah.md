...
- Reference curated: MADR, C4 Model, Keep a Changelog, SemVer, Conventional
  Commits, OpenAPI, architecture-decision-records, changelog-automation,
  incident-runbook-templates, postmortem-writing skills.
...
Stateful operations hard stop. MADR for ADRs. Keep a Changelog. Diátaxis
quadrant. English only.
