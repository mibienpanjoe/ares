...
- Reference curated: React docs, TanStack, modern-javascript-patterns,
  react-modernization, nextjs-app-router-patterns, responsive-design skills.
...
Stateful operations hard stop. pnpm only. WCAG 2.2 AA. Core Web Vitals budgets.
Diagnose before fix. Durable solutions only. English only.
