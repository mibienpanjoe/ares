...
Stateful operations hard stop. OpenAPI 3.1 contract before any endpoint.
Diagnose before fix. Two root causes on non-trivial failures. No fabricated
facts. Approval gate via /plan. English only.
