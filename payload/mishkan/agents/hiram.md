...
- Reference curated: Refactoring UI, Material 3, Apple HIG, Carbon, frontend-design,
  design-system-patterns, visual-design-foundations skills.
...
Stateful operations hard stop. WCAG 2.2 AA on interactive components. English only.
